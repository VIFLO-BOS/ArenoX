               ...
               <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                  ...
                  <div className="flex flex-col justify-between items-center bg-white hover:bg-blue-100 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-500">
                     ...
                     <div className="flex  justify-center flex-end space-x-4 mt-4">
                        <a href="#" className=""><i className="bi bi-facebook hover:!text-blue-500"></i></a>
                        <a href="#" className=""><i className="bi bi-twitter hover:!text-blue-500"></i></a>
                        <a href="#" className=""><i className="bi bi-linkedin hover:!text-blue-500"></i></a>
                        <a href="#" className=""><i className="bi bi-instagram hover:!text-blue-500"></i></a>
                     </div>
                  </div>

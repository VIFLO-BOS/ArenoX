...
const Footer_content = () => {
   return (
      <footer className="bg-gradient-to-br from-blue-50 via-white to-blue-100 z-1 text-gray-300 py-12">
         <motion.div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-8" initial={{ opacity: 0, y: 20 }}
         ...
         {/* Bottom Bar */}
         <div className="flex justify-between px-15 mt-8 border-t border-gray-700 pt-4 text-center text-xs text-gray-400">

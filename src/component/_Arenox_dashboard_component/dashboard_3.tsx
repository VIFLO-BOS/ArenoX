...
export default function aInstructor_Dashboard2() {
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-white shadow-md">
        <div className="p-6 text-2xl font-bold text-blue-600">UX PILOT</div>
        <nav className="mt-6">
          <ul>
            ...
            <li className="px-6 py-3 hover:bg-blue-50 flex items-center gap-2 cursor-pointer">
              <Users className="w-5 h-5 text-gray-600" /> Instructors
            </li>
            <li className="px-6 py-3 hover:bg-blue-50 flex items-center gap-2 cursor-pointer">
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="p-6 space-y-6 overflow-y-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Progress bars */}
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="font-semibold mb-4">Students by Course</h3>

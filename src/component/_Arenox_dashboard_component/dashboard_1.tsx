      ...
      <main className="flex-1 p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white p-4 rounded-xl shadow">
            ...
            <p className="text-green-500 text-sm">67% completion rate</p>
          </div>
          <div className="bg-white p-4 rounded-xl shadow">
            <p className="text-gray-500">Study Hours</p>
            <h3 className="text-2xl font-bold">48</h3>
            <p className="text-green-500 text-sm">+5.2 hrs this week</p>
          </div>
          <div className="bg-white p-4 rounded-xl shadow">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="bg-white p-4 rounded-xl shadow flex justify-between items-center">
              <div>
                <p className="font-medium">UI/UX Design Basics</p>
                <p className="text-sm text-gray-500">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-4 rounded-xl shadow">
              ...
              <ul className="mt-2 space-y-2">
                ...
                <li className="flex justify-between items-center bg-yellow-100 px-3 py-2 rounded">
                  ...
                  <span className="text-yellow-600 text-sm">Soon</span>
                </li>
            ...
            <div className="bg-white p-4 rounded-xl shadow">
              ...
              <p className="text-sm text-gray-600 mt-2">
                ✅ Completed lesson: <b>Variables and Data Types</b> (2 hours
                ago)
              </p>
            </div>
          </div>
